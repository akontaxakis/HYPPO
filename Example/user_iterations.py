...
from components.Ensemblers.CustomAverageEnsemble import GL__AverageRegressorLoader
from components.Ensemblers.CustomStackingEnsemble import GL__StackingRegressorLoader
from components.Ensemblers.StackingEnsemble import SetackingEnsemble
from components.Ensemblers.VotingEnsemble import VotingRegressorLoader
...
from components.Evaluation.KS import KS
from components.Evaluation.ComputeAUC import ComputeAUC
from components.Evaluation.MAECalculator import MAECalculator
from components.Evaluation.MPECalculator import MPECalculator
from components.Evaluation.MSECalculator import MSECalculator
from components.General_Python_libraries.GL_LibSVMEstimator import GL__SVMLibEstimator
from components.General_Python_libraries.GL_MeanImputer import GL__SimpleImputer
from components.General_Python_libraries.GL_PolynomialFeatures import GL__PolynomialFeatures
from components.General_Python_libraries.GL_ScipyScaler import GL__StScaler
...
from components.Regressors.GL__DecisionTreeRegressor import GL__DecisionTreeRegressor
from components.Regressors.GL__KNeighborRegressor import GL__KNeighborsRegressor
from components.Regressors.GL__LGBM import GL__LGBMRegressor
from components.Regressors.GL__LassoGLM import GL__LassoGLM
from components.Regressors.TF_Ridge import TF__Ridge
from components.Regressors.TF__LinearRegressor import TF__LinearRegressor
from components.SVM.SVM_PyTorch import TR__LinearSVC
from components.SVM.SVM_TensorFlow import TF__LnearSVC
from components.SVM.TF_SV import TF__LinearSVC
...
collab_TAXI_all_operators= [
    ...
    ('RI', [
       Ridge(alpha=75.0), TF__Ridge(alpha=75.0)]),
    ('LGBM', [
...
collab_TAXI_all_operators_advance = [
    ...
    ('FE', [CustomFeatureEngineer()]),
    ('VR(2)', [
        GL__AverageRegressorLoader(models_dir="taxi_models", n_models=2)]),
    ('VR(3)', [
        GL__AverageRegressorLoader(models_dir="taxi_models", n_models=3)]),
    ('VR(4)', [
        GL__AverageRegressorLoader(models_dir="taxi_models", n_models=4)]),
    ('VR(5)', [
        GL__AverageRegressorLoader(models_dir="taxi_models", n_models=5)]),
    ('SE(2)', [
        GL__StackingRegressorLoader(models_dir="taxi_models", n_models=2)]),
    ('SE(3)', [
        GL__StackingRegressorLoader(models_dir="taxi_models", n_models=3)]),
    ('SE(4)', [
        GL__StackingRegressorLoader(models_dir="taxi_models", n_models=4)]),
    ('SE(5)', [
        GL__StackingRegressorLoader(models_dir="taxi_models", n_models=5)]),
    ('MSE', [
        MSECalculator('nan')]),
    ('MAE', [
        MAECalculator('nan')]),
