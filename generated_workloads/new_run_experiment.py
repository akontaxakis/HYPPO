...
from libs.artifact_graph_lib import init_graph, add_load_tasks_to_the_graph, execute_pipeline, rank_based_materializer, \
    ...
    split_data, create_equivalent_graph, new_eq_edges
...
if __name__ == '__main__':
    ...
    for trial in Trails:
        ...
        for b in Budget:
            ...
            equivalent_graph = create_equivalent_graph(sh_previous_graph_2)
            required_nodes, extra_cost_2 = new_eq_edges(execution_graph, equivalent_graph)
